                ...
                if (apiData != nil) {
                    VStack {
                        ...
                        URLImage(li16) {
                            ...
                            NavigationLink(
                                destination:
                                    LocationView(location: "Lindengasse 16", image: image, id: "li16", rawImage: info.cgImage, date: li16date, videos: apiData!.li16.videos),
                                label: {
                                    image
                                        .resizable()
                                        .aspectRatio(4 / 3, contentMode: .fit)
                        ...
                        URLImage(li27) {
                            ...
                            NavigationLink(
                                destination:
                                    LocationView(location: "Lindengasse 27", image: image, id: "li27", rawImage: info.cgImage, date: li27date, videos: apiData!.li27.videos),
                                label: {
                                    image
                                        .resizable()
                                        .aspectRatio(16 / 9, contentMode: .fit)
